...
public class AllDelieveryBoys extends AppCompatActivity {
    ...
    private String cName, cAddress, cCity, cPhone, oDate, restID, oState, oTime, oTotalAmount, uPhone, userID;
                    ...
                    protected void onBindViewHolder(@NonNull DeliveryBoyViewHolder holder, final int position, @NonNull final DeliveryBoy model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                ...
                                Intent intent = new Intent(AllDelieveryBoys.this, AdminMaintainDelBoy.class);
                                intent.putExtra("delID", model.getPhone());
