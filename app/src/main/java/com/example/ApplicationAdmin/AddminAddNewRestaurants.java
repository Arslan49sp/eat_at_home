...
public class AddminAddNewRestaurants extends AppCompatActivity {
    ...
    private void storeProductInformation() {
        ...
        // code to get new current date and time and make Random key.
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(AddminAddNewRestaurants.this, "Restaurant  is added successfully..", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
