...
public class AdminHireNewDelievryBoy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // creating firebase storage reference to store DelieveryBoy images
    ...
    private void storedelboyInformation() {
        ...
        // Getting current date and time to create random key for Delievery boy....
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(AdminHireNewDelievryBoy.this, "Dilevery Boy Hired :P", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
