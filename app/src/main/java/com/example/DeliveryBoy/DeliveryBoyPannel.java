...
public class DeliveryBoyPannel extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<AdminOrders, DelBoyViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, DelBoyViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull DelBoyViewHolder holder, final int position, @NonNull final AdminOrders model)
                    {
                                ...
                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i)
                                    {
                                        if (i == 0)
                                        {
                                            ...
                                            String userphone = model.getUphone();
    ...
    public static class DelBoyViewHolder extends RecyclerView.ViewHolder
    {
