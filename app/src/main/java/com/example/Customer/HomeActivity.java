...
import com.example.ApplicationAdmin.AdminMaintainRestaurants;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // paper is a third-party library to store information of the loged in user.
        ...
        // for Navigation drawer viwer options
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId())
                {
                    ...
                    case R.id.nav_settings:
                        ...
                        if (!type.equals("Admin"))
                        {
                          Intent  intent = new Intent(HomeActivity.this, CustomerSettingActivity.class);
                            startActivity(intent);
                        }
                    ...
                    protected void onBindViewHolder(@NonNull RestaurantViewHolder holder, int position, @NonNull final Restaurants model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                if (type.equals("Admin"))
                                {
                                    Intent intent = new Intent(HomeActivity.this, AdminMaintainRestaurants.class);
                                    intent.putExtra("rid", model.getPhone());
                                    startActivity(intent);
                                }
                                else
                                {
